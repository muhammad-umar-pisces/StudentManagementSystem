...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post metrics_url, params: { metric: { Biology: @metric.Biology, Chemistry: @metric.Chemistry, Computer: @metric.Computer, Math: @metric.Math, Physics: @metric.Physics } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { Biology: @metric.Biology, Chemistry: @metric.Chemistry, Computer: @metric.Computer, Math: @metric.Math, Physics: @metric.Physics } }
